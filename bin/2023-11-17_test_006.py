...
from hackeeg.ReadLine import ReadLine
...
try:
    ...
    # reader = ReadLine(hackeeg.raw_serial_port)
    ...
    while ((sample_counter < max_samples) and (sample_counter < max_sample_time)):
        ...
        # result = hackeeg.raw_serial_port.read(38)
        # result = hackeeg.raw_serial_port.read(hackeeg.raw_serial_port.in_waiting)
        # result = hackeeg.raw_serial_port.readline()
    ...
    # tqdm.write(f"last sample: {samples[-1]}")
