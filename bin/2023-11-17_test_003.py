...
try:
    ...
    progress = tqdm(total = max_sample_time, miniters=10)
    ...
    while(sample_counter < max_sample_time):
        # result = hackeeg.read_rdatac_response()
        # result = hackeeg._serial_read_messagepack_message()
        result1 = hackeeg.message_pack_unpacker.unpack()
        result2 = hackeeg.message_pack_unpacker.unpack()
